              ...
              <div className="relative">
                <div className="aspect-video bg-app-tertiary rounded-lg border border-app overflow-hidden relative">
                  {option.imageUrl ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-app-muted p-4">
                      <svg className="w-12 h-12 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                      <p className="text-center text-sm">
                        Drop image here<br />
                        <span className="text-xs">or add URL below</span>
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  ...
                  <label 
                    ...
                    className="w-full btn-gradient-border flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-[11px] font-medium text-cotton-purple cursor-pointer hover:scale-[1.03] hover:shadow-lg transition-all duration-200 leading-none"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
