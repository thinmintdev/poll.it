...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full bg-poll-dark border-t border-poll-grey-700 mt-auto">
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-poll-grey-400 text-sm">
            © {currentYear} Poll.it. All rights reserved.
          </div>
